    ...
    <>
      ...
      <nav
        style={{
          ...
          transition: "background 0.6s cubic-bezier(0.16,1,0.3,1), border-color 0.6s ease, box-shadow 0.6s ease",
        }}
      >
        {/* Logo */}
        <Link href="/" style={{ textDecoration: "none" }}>
          <span style={{
            ...
            T<span style={{ color: "var(--accent)", fontStyle: "italic" }}>.</span>N
          </span>
        </Link>

        {/* Desktop links */}
        <ul className="hidden lg:flex" style={{ display: "flex", gap: "2.8rem", listStyle: "none", alignItems: "center" }}>
          {NAV_LINKS.map((link) => (
            <li key={link.key}>
              <a
                href={link.href}
        ...
        <button
          ...
          style={{ background: "none", border: "none", cursor: "pointer", color: "var(--text)", padding: "0.2rem" }}
        >
          ...
          <div style={{
            ...
            {NAV_LINKS.map((link) => (
              <a
                ...
                style={{
                  fontSize: "1.05rem", color: "var(--text)", textDecoration: "none",
            ...
            <a
              ...
              style={{
                ...
                border: "1px solid rgba(200,160,90,0.4)", color: "var(--accent)",
                padding: "0.65rem 1.3rem", borderRadius: "var(--radius)", textDecoration: "none",
